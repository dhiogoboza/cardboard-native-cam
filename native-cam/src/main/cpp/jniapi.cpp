...
static nv::NVApp *kApp = nullptr;
static ANativeWindow *kWindow = nullptr;

jobject jni_surfacetexture = nullptr;
...
void android_app_update_tex_image() {
    ...
    if (jni_surfacetexture && request_update_tex) {
